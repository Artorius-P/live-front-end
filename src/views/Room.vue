...
<div>
  <div v-if="this.$store.state.loginInfo.isLoggedIn">
    ...
    <el-row>
    <el-button @click="whiteBoard = true" icon="el-icon-edit" style="margin-left: 16px;" plain>
        白板
    </el-button>
    <el-button @click="showchat" icon="el-icon-chat-round"  style="margin-left: 16px;" plain>
        聊天
    </el-button>
  </el-row>
    <el-drawer
